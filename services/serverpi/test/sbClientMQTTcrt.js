...
var fs = require('fs')
var ca = fs.readFileSync('/home/iot/certs/sbCaChain.pem')
console.log(ca)
 
//options doesn't work for wss 
var piOptions = {
  port:2013, //these don't work
  host: 'sitebuilt.net', //these don't work
  rejectUnauthorized: false,
  ca: ca
}
//piClient = mqtt.connect('mqtt://sitebuilt.net:2012');
piClient = mqtt.connect('wss://sitebuilt.net:2013', piOptions);
